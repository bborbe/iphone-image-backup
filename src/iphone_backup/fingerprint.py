...
class FingerprintManager:
    ...
    def _build_fingerprint_cache(self) -> None:
    ...
    def is_duplicate(self, file_data: bytes) -> tuple[bool, FileFingerprint | None]:
    ...
    def get_duplicate_info(self, file_data: bytes) -> dict[str, bool | str | int | datetime | None]:
    ...
    def add_file_to_cache(self, file_path: Path, file_data: bytes) -> None:
