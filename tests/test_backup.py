...
class TestiPhonePhotoBackup(unittest.TestCase):
    ...
    def test_backup_photo_new_file(self):
        ...
        self.backup.fingerprint_manager.add_file_to_cache.assert_called_once_with(
            expected_path, file_data
        )
    ...
    def test_get_backup_stats(self):
        ...
        expected = {"total_photos": 0, "backed_up": 5, "skipped": 3, "duplicates": 0, "errors": 1}
